...
export async function verifyClaim(claim: ClaimToVerify): Promise<VerificationResult> {
  const response = await getAnthropic().messages.create({
    ...
    messages: [
      {
        role: "user",
        content: `אתה עורך בכיר באתר בדיקת עובדות, ומאשר/דוחה בדיקות שעברו אליך לאישור סופי לפני פרסום. הסטנדרט שלך: דחה רק כשיש פגם ברור. אל תדחה רק כי משהו אינו מושלם.
...
תאשר את רוב הטענות. דחה רק כשהפגם ברור וחד-משמעי.`,
      },
    ],
  });
