...
8. **הציטוט הוא דיווח עיתונאי, לא אמירה של הפוליטיקאי** — דגל קריטי. סימנים:
   ...
   - דוגמאות לדחייה: "חתם על צו לפינוי..." (פועל בגוף שלישי בלי מרכאות), "בעקבות הסרטונים של X, נוצר גל גינויים..." (תוצאה של פעולה), "סרטון המשט שהפיק X" (תיאור פריט תקשורתי), "X פגש את ראש הממשלה" (דיווח פעולה).
