...
export default function AboutPage() {
  return (
    <article className="prose prose-sm max-w-2xl mx-auto" dir="rtl">
      ...
      <Section title="ניקוד הטעיה — איך מחשבים?">
        <p>
          המספר הגדול שמופיע לצד כל פוליטיקאי הוא <strong>ניקוד הטעיה</strong>: כמה הוא הטעה את הציבור.
          כל טענה שנמצאה <strong>שקר</strong> שווה נקודה אחת, כל <strong>חצי-אמת</strong> חצי נקודה.
        </p>
        <p>
          ככל שהניקוד גבוה יותר, הפוליטיקאי הפיץ יותר מידע מוטעה. אחוז האמת הגולמי
          {" "}<strong>(אמת + ½ × חצי) ÷ סה&quot;כ</strong> מוצג כקו תחתון בכל כרטיס.
        </p>
        <p>
          הניקוד מודד דיוק עובדתי בלבד, לא יושרה או מוסר. שימו לב: פוליטיקאים שמדברים יותר נבדקים יותר,
          ולכן עשויים לצבור ניקוד גבוה יותר.
        </p>
      </Section>
