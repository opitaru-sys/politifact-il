    ...
    <article className="prose prose-sm max-w-2xl mx-auto" dir="rtl">
      ...
      <Section title="איך זה עובד">
        <ol className="list-decimal pr-5 space-y-1.5">
          ...
          <li>מודל בינה מלאכותית מחלץ את הטענות העובדתיות הניתנות לאימות. דעות, סלוגנים, האשמות כלליות והבטחות עתיד נדחות בשלב הזה ולא ממשיכות הלאה.</li>
          <li>מודל נוסף בודק כל טענה מול חיפוש Google חי, נותן פסק דין (אמת / חצי אמת / שקר), ומציין את המקור הציבורי שעליו התבסס.</li>
          <li>
            <strong>בדיקה אוטומטית נוספת:</strong> מודל שלישי, ספקני ואדוורסרי, בוחן את הבדיקה הראשונה
            לפי שבעה קריטריונים — תקפות הפסק, תמיכת ההסבר, ניטרליות פוליטית, מהימנות המקור, התאמה לציטוט המקורי,
            זיהוי בלבול זמני בין אירועים, ודחיית מקרים שבהם פסק &ldquo;אמת&rdquo; ניתן רק כי הציטוט מצוטט נכון
            (ולא כי תוכנו אומת). <strong>רק טענות שעוברות את הבדיקה הזו מתפרסמות לציבור.</strong>
            טענות שלא עוברות נדחות ואינן מופיעות באתר; אפשר לראות אותן רק בלוח האדמין הפנימי.
          </li>
